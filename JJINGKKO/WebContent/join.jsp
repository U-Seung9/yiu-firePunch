  ...
  <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#JJING_KKO)">
  	...
  	<div class="join">
  		<div class="box2">
  			<form method="post" action="joinAction.jsp" >
  				<div class="input">
  					<input type="text" class="id" name="uId" placeholder="아이디를 입력하세요" maxlength="10">
  					<input type="password" class="pwd" name="uPwd" placeholder="비밀번호를 입력하세요" maxlength="10">
  				</div>
  				<div class="input">
  					<input type="text" class="name" name="uName" placeholder="이름을 입력하세요" maxlength="10">
  					<br><br>
  				...
  				<div class="input">
  					<input type="email" class="email" name="uEmail" placeholder="이메일을 입력하세요" maxlength="50">
  				</div>
					<div class="input">
	  					<input type="submit" class="sub" value="JOIN">
	  				</div>
  				</form>
  		</div>
  	</div>
	...
	<footer class="foot">
      ...
      <div class="E">
        ...
        <ul class="icon">
        <a class="kakao" href=""><i class="fab fa-instagram"></i></a>
        <a class="kakao" href=""><i class="fab fa-twitter"></i></a>
        <a class="kakao" href=""><i class="fab fa-facebook-square"></i></a>
      </ul>
      </div>
