  	...
  	<div class="login">
  		<div class="box">
  			<form method="post" action="loginAction.jsp" >
  				<div class="input">
  					<input type="text" class="id" placeholder="아이디" name="uId" maxlength="20">
  				</div>
  				<div class="input">
  					<input type="password" class="pwd" placeholder="비밀번호" name="uPwd" maxlength="20">
  				</div>
  				<div class="input">
